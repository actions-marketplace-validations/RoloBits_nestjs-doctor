...
> **Purpose:** Internal reference documenting **why** each of the 52 rules exists, backed by official sources. Also serves as a quality audit — issues with descriptions, categories, or detection logic are flagged with `🔶 ISSUE`.
>
> **Date:** 2026-03-14
>
...
14 issues audited across 52 rules — all resolved (7 fixed in code, 7 resolved as non-actionable):
