...
# Scan a NestJS project with npx nestjs-doctor
...
No config file, nothing to set up. It reads your TypeScript, runs its rules, and
...
| `2` | Bad input: the path does not exist, holds no TypeScript files, or a flag is invalid |
